/**
 * 0x1a9bf5BC09d9e288611aaEA866cdCa3b26369148
...
// Original license: SPDX_License_Identifier: MIT
//pragma solidity ^0.8.9;
contract SECURITY is Initializable, UUPSUpgradeable, ERC1066, Utility {
    ...
    function whiteListBach(address[] calldata _people, uint256 _amount) external virtual whenNotPaused onlyRole(WHITELISTER_ROLE) returns (uint256 max) {
        ...
        while(_size != 0) {
            ...
            _addr = _people[_size];
            _link = exchange.link(_addr);
            if( _link != address(0x0) ) {
